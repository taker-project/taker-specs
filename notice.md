...
Следует избегать коротких и однобуквенных названий переменных и функций, а так же названий, которые можно трактовать различными способами.
...
Названия полей и методов класса, функций должны писаться в lowerCamelCase: `myLittleCamel`.

...
Все относительные пути, указанные в параметрах (например, в полях `"executable"`, `"working-dir"` и `"isolate-dir"`), указаны относительно рабочей папки самого runner'а (а не относительно рабочей папки запускаемой программы, например)

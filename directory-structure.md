...
│ ├─🗋 olymp.sty
│ └─🗋 constraints.sty // Файл, где хранятся ограничения для использования их в LaTeX
├─🗁 generators
│ ├─🗋 gen1.cpp
│ ├─🗋 gen2.cpp
│ ├─ ...
...
│ │ ├─🗋 notes.tex
│ │ ├─🗋 scoring.tex
│ │ ├─🗋 statements.tex // Шаблон задачи, который подключает legend.tex, input.tex, output.tex, ...
│ │ ├─🗋 problem.tex // Основной файл задачи
│ │ └─🗋 Makefile // Генерируется системой
│ ├─🗋 config // Параметры условий, описаны в statements-config.md
│ └─🗋 Makefile // Генерируется системой
├─🗁 stresses
│ ├─🗋 my
│ ├─🗋 stress42
